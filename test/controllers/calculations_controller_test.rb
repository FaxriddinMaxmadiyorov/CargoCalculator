...
class CalculationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calculation" do
    assert_difference("Calculation.count") do
      post calculations_url, params: { calculation: { dep_point: @calculation.dep_point, dest_point: @calculation.dest_point, email: @calculation.email, firstname: @calculation.firstname, height: @calculation.height, lastname: @calculation.lastname, length: @calculation.length, middlename: @calculation.middlename, phone_number: @calculation.phone_number, weight: @calculation.weight, width: @calculation.width } }
    end
  ...
  test "should update calculation" do
    patch calculation_url(@calculation), params: { calculation: { dep_point: @calculation.dep_point, dest_point: @calculation.dest_point, email: @calculation.email, firstname: @calculation.firstname, height: @calculation.height, lastname: @calculation.lastname, length: @calculation.length, middlename: @calculation.middlename, phone_number: @calculation.phone_number, weight: @calculation.weight, width: @calculation.width } }
